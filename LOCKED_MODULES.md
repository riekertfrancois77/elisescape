...
studio rule for all of them: **Eli's brain first, then AI reviews, researches,
and builds.**

## Opened by Dad — the "make your game visibly better" run (unlock in order)

5. **Read the Machine** 🔓 — Read your *own* game's code and make your first solo
   edit. Understand the machine you built. → **v0.2** *(active)*
6. **Speak AI Fluently** 🔓 — Words are your controller. Sharpen your prompts by
   directing real game polish. → **v0.3**
7. **Create Worlds** 🔓 — Give your game real graphics and atmosphere. *You*
...
12. **Cross Into the Real World** 🔒 — Your studio skills escape the screen. The
